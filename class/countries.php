...
class Countries
{
    ...
    public function createCountry($country_code, $other_country_key, $name, $full_name, $nationality, $full_nationality, $country_vehicle_key, $language_key, $major_currency_index, $major_currency, $member_euro, $trade_statistic_abbreviation, $step, $capital_goods_indicator, $iso_key, $three_iso_key, $intrastat_key, $address_outline_key, $standard_name_format, $type_country_name, $date_format, $decimal_format)
    {
        $query = 'INSERT INTO cm_sap.tb_countries (country_code, other_country_key, name, full_name, nationality, full_nationality, country_vehicle_key, language_key, major_currency_index, major_currency, member_euro, trade_statistic_abbreviation, step, capital_goods_indicator, iso_key, three_iso_key, intrastat_key, address_outline_key, standard_name_format, type_country_name, date_format, decimal_format, created_at, updated_at, is_deleted) 
        ...
        $result = pg_execute($this->connection, "create_country", array($country_code, $other_country_key, $name, $full_name, $nationality, $full_nationality, $country_vehicle_key, $language_key, $major_currency_index, $major_currency, $member_euro, $trade_statistic_abbreviation, $step, $capital_goods_indicator, $iso_key, $three_iso_key, $intrastat_key, $address_outline_key, $standard_name_format, $type_country_name, $date_format, $decimal_format));
        if (!$result) {
    ...
    public function updateCountry($encryptedCountryId, $country_code, $other_country_key, $name, $full_name, $nationality, $full_nationality, $country_vehicle_key, $language_key, $major_currency_index, $major_currency, $member_euro, $trade_statistic_abbreviation, $step, $capital_goods_indicator, $iso_key, $three_iso_key, $intrastat_key, $address_outline_key, $standard_name_format, $type_country_name, $date_format, $decimal_format)
    {
        ...
        $result = pg_execute($this->connection, "update_country", array($countryId, $country_code, $other_country_key, $name, $full_name, $nationality, $full_nationality, $country_vehicle_key, $language_key, $major_currency_index, $major_currency, $member_euro, $trade_statistic_abbreviation, $step, $capital_goods_indicator, $iso_key, $three_iso_key, $intrastat_key, $address_outline_key, $standard_name_format, $type_country_name, $date_format, $decimal_format));
        if (!$result) {
