    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($missing_fields)) {
            ...
            if ($countryId) {
                ...
                echo json_encode(["status" => "success", "message" => "Country created successfully", "country_id" => $countryId]);
            } else {
