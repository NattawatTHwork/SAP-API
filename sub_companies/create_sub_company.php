...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($missing_fields)) {
            ...
            $subCompanyId = $subCompany->createSubCompany(
                $company_id,
                $sub_company_code,
                $sub_company_name,
                $cnpj_bus_place,
            ...
            if ($subCompanyId) {
                ...
                echo json_encode(["status" => "success", "message" => "Sub-company created successfully", "sub_company_id" => $subCompanyId]);
            } else {
                throw new Exception("Error creating sub-company.");
            }
        } else {
